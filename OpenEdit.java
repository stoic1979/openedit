...
public class OpenEdit extends JFrame implements ActionListener {
    ...
    public OpenEdit(){
        super("OpenEdit - The Open Graphics Editor By WeaveBytes Infotech");
    ...
    private void setupMenus() {
        ...
        miSaveAs.setToolTipText("Save As OpenEdit graphics file... ");
        ...
        miStar.setToolTipText("Draw star on the Screen..");
        mShapes.add(miStar);
        ...
        JMenuItem miHelp = new JMenuItem("OpenEdit Help", new ImageIcon(getClass().getResource("images/icons/32x32/help.png")));
        miHelp.setMnemonic(KeyEvent.VK_P);
        miHelp.setToolTipText("OpenEdit Help is a very user friendly help system that helps the users to quickly understand OpenEdit.");
        mHelp.add(miHelp);

        JMenuItem miAbout = new JMenuItem("About", new ImageIcon(getClass().getResource("images/icons/16x16/vg.png")));
        miAbout.setToolTipText("OpenEdit Help is a very user friendly help system that helps the users to quickly understand OpenEdit.");
    ...
    public void actionPerformed(ActionEvent event) {
        if(event.getActionCommand().equals(Config.CMD_ABOUT)) {     
            new AboutDialog(this, "OpenEdit- The Open Graphics Editor", "Graphics Editor Under Construction....");       
        }
